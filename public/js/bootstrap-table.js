...
! function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showTotal) {
            html.push(sprintf('<button id="totalDiv" onclick="showTotal();" class="btn btn-default" type="button" name="paginationSwitch">显示累计数据</button>'));
        }

        if (this.options.showRange) {
            html.push(sprintf('从<input id="rangeFrom" class="btn btn-default" style="width:50px;">月 到<input id="rangeTo" class="btn btn-default" style="width:50px;">月'));
        }
        ...
        if (this.options.showRefresh) {
            html.push(sprintf('<button id="refreshButton" class="btn btn-default' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" name="refresh" title="%s">',
                    this.options.formatRefresh())+"更新"+
                '</button>');
        }
